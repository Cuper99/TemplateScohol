...
<nav class="navbar navbar-expand-md bg-secondary navbar-dark fixed-top shadow">
    <img class="mb-4" src="assets/img/logo.png" alt="" width="50" height="50">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link active" href="#"><i class="fas fa-home fa-lg d-md-none pr-2 "></i>Acasa</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="about.html"><i class="fas fa-info-circle fa-lg d-md-none pr-2"></i> Inscriere</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="pricing.html"><i class="fas fa-rupee-sign fa-2x d-md-none pr-2"></i> Istoric</a>
            </li>
            <li class="nav-item">
